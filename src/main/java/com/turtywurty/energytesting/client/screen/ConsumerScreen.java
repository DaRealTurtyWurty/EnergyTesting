...
public class ConsumerScreen extends ContainerScreen<ConsumerContainer> {

	private static final ResourceLocation TEXTURE = new ResourceLocation(EnergyTesting.MOD_ID,
			"textures/gui/consumer.png");

	public ConsumerScreen(ConsumerContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
